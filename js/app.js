...
const TRANSLATIONS = {
  es: {
    ...
    "btn-follow-tiktok": "<i class=\"fab fa-tiktok\"></i> Ver videos de productos",
    ...
    "footer-desc": "Importadores directos desde fábrica a tu local. Bolsas, mochilas, peluches y novedades con el mejor precio y la mejor atención de CDMX.",
  ...
  zh: {
    ...
    "btn-follow-tiktok": "<i class=\"fab fa-tiktok\"></i> 观看产品视频",
    ...
    "footer-desc": "厂家直接进口至您的店面。CDMX 价格最优、服务最好的包袋、双肩包、毛绒玩偶及新奇产品进口商。",
    "footer-nav": "导航",
    "footer-contact": "联系方式",
